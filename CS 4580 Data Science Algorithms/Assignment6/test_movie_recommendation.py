...
import movie_recommendation as ca  # TODO: UPDATE to student file
    ...
    with patch('requests.get') as mock_get:
        ...
        with patch('builtins.print') as mock_print:
            ...
            mock_print.assert_called_with(
                f'Error downloading dataset {data_file} from {url}/{data_file}')
...
def test_load_data_invalid_file_format():
    ...
    with patch('builtins.print') as mock_print:
        with pytest.raises(ValueError):
            ca.load_data(file_path)
        mock_print.assert_called_with(
            f'File {file_path} is not a valid CSV file')
