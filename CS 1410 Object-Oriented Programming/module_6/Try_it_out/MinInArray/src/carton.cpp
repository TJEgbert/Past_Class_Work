...
/**
 * @brief: Overload operator of the < is compare the volume of the Cartons objects
 * @param rhs: the second Carton object, or the one on the "Right Hand Side"
 * @return: The Carton Object with teh smallest Volume.
 */
