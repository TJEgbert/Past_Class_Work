...
/**
 * @brief: None default constructor that sets the measurements with the set_measurements
 * @param address Address: used to set address_
 * @param weight double: used to set weight_
 * @param side1 double: used to set side1
 * @param side2 double: used to set side2
 * @param side3 double: used to set side3
 */
...
/**
 * @brief: outputs the Carton data to an ostream in a format with one decimal
 * Carton: weight lbs. length x width x height
 * @param out ostream: the ostream you want to output to
 */
void Carton::Display(std::ostream &out) const
{
    out << std::fixed << std::setprecision(1) <<
    "Carton: " << weight_ << " lbs. " << length_ << " x " << width_ << " x " << height_ << std::endl;
}
